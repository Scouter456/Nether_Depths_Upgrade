...
public class NDUConfiguredFeatures {
    ...
    //CRIMSON
    public static final RegistryObject<ConfiguredFeature<?, ?>> CONFIGURED_CRIMSON_SEAGRASS_SIMPLE = registerConfiguredFeature(CRIMSON_SEAGRASS_SIMPLE_FEATURE_NAME, () -> new ConfiguredFeature<>(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(NDUBlocks.CRIMSON_SEAGRASS.get()))));

    public static final RegistryObject<ConfiguredFeature<?, ?>> CONFIGURED_CRIMSON_KELP = registerConfiguredFeature(CRIMSON_KELP_FEATURE_NAME, () -> new ConfiguredFeature<>(NDUFeatures.CRIMSON_KELP.get(), new NoneFeatureConfiguration()));

    public static final RegistryObject<ConfiguredFeature<?, ?>> CONFIGURED_CRIMSON_SEAGRASS_SHORT = registerConfiguredFeature(CRIMSON_SEAGRASS_SHORT_FEATURE_NAME, () -> new ConfiguredFeature<>(NDUFeatures.CRIMSON_SEAGRASS.get(), new ProbabilityFeatureConfiguration(0.3F)));

    public static final RegistryObject<ConfiguredFeature<?, ?>> CONFIGURED_CRIMSON_SEAGRASS_SLIGHTLY_LESS_SHORT = registerConfiguredFeature(CRIMSON_SEAGRASS_SLIGHTLY_LESS_SHORT_FEATURE_NAME, () -> new ConfiguredFeature<>(NDUFeatures.CRIMSON_SEAGRASS.get(), new ProbabilityFeatureConfiguration(0.4F)));
    public static final RegistryObject<ConfiguredFeature<?, ?>> CONFIGURED_CRIMSON_SEAGRASS_MID= registerConfiguredFeature(CRIMSON_SEAGRASS_MID_FEATURE_NAME, () -> new ConfiguredFeature<>(NDUFeatures.CRIMSON_SEAGRASS.get(), new ProbabilityFeatureConfiguration(0.6F)));
    public static final RegistryObject<ConfiguredFeature<?, ?>> CONFIGURED_CRIMSON_SEAGRASS_TALL = registerConfiguredFeature(CRIMSON_SEAGRASS_TALL_FEATURE_NAME, () -> new ConfiguredFeature<>(NDUFeatures.CRIMSON_SEAGRASS.get(), new ProbabilityFeatureConfiguration(0.8F)));
    ...
    public static final RegistryObject<PlacedFeature> WARPED_KELP_PLACED_COMMON = registerPlacedFeature(WARPED_KELP_FEATURE_COMMON_NAME_PLACED, () -> new PlacedFeature(CONFIGURED_WARPED_KELP.getHolder().orElseThrow(), ImmutableList.of(
    ...
    public static final RegistryObject<PlacedFeature> WARPED_SEAGRASS_TALL_PLACED_COMMON = registerPlacedFeature(WARPED_SEAGRASS_COMMON_TALL_FEATURE_NAME_PLACED, () -> new PlacedFeature(CONFIGURED_WARPED_SEAGRASS_TALL.getHolder().orElseThrow(), ImmutableList.of(
            InSquarePlacement.spread(),
            PlacementUtils.HEIGHTMAP_TOP_SOLID,
    ...
    public static final RegistryObject<PlacedFeature> CRIMSON_SEAGRASS_SIMPLE_PLACED = registerPlacedFeature(CRIMSON_SEAGRASS_SIMPLE_FEATURE_NAME_PLACED, () -> new PlacedFeature(CONFIGURED_CRIMSON_SEAGRASS_SIMPLE.getHolder().orElseThrow(), ImmutableList.of(
            CarvingMaskPlacement.forStep(GenerationStep.Carving.LIQUID),
            RarityFilter.onAverageOnceEvery(10),
            BlockPredicateFilter
                    .forPredicate(
    ...
    public static final RegistryObject<PlacedFeature> CRIMSON_KELP_PLACED = registerPlacedFeature(CRIMSON_KELP_FEATURE_NAME_PLACED, () -> new PlacedFeature(CONFIGURED_CRIMSON_KELP.getHolder().orElseThrow(), ImmutableList.of(
            NoiseBasedCountPlacement.of(80, 80.0D, 0.0D),
            InSquarePlacement.spread(),
            PlacementUtils.HEIGHTMAP_TOP_SOLID,
            BiomeFilter.biome())));

    public static final RegistryObject<PlacedFeature> CRIMSON_KELP_PLACED_COMMON = registerPlacedFeature(CRIMSON_KELP_FEATURE_COMMON_NAME_PLACED, () -> new PlacedFeature(CONFIGURED_CRIMSON_KELP.getHolder().orElseThrow(), ImmutableList.of(
            NoiseBasedCountPlacement.of(256, 80.0D, 0.0D),
            InSquarePlacement.spread(),
            PlacementUtils.HEIGHTMAP_TOP_SOLID,
            BiomeFilter.biome())));
    ...
    public static final RegistryObject<PlacedFeature> CRIMSON_SEAGRASS_SHORT_PLACED = registerPlacedFeature(CRIMSON_SEAGRASS_SHORT_FEATURE_NAME_PLACED, () -> new PlacedFeature(CONFIGURED_CRIMSON_SEAGRASS_SHORT.getHolder().orElseThrow(), ImmutableList.of(
            InSquarePlacement.spread(),
            PlacementUtils.HEIGHTMAP_TOP_SOLID,
            CountPlacement.of(80),
            BiomeFilter.biome())));

    public static final RegistryObject<PlacedFeature> CRIMSON_SEAGRASS_SLIGHTLY_LESS_SHORT_PLACED = registerPlacedFeature(CRIMSON_SEAGRASS_SLIGHTLY_LESS_SHORT_FEATURE_NAME_PLACED, () -> new PlacedFeature(CONFIGURED_CRIMSON_SEAGRASS_SLIGHTLY_LESS_SHORT.getHolder().orElseThrow(), ImmutableList.of(
            InSquarePlacement.spread(),
            PlacementUtils.HEIGHTMAP_TOP_SOLID,
            CountPlacement.of(48),
            BiomeFilter.biome())));

    public static final RegistryObject<PlacedFeature> CRIMSON_SEAGRASS_MID_PLACED = registerPlacedFeature(CRIMSON_SEAGRASS_MID_FEATURE_NAME_PLACED, () -> new PlacedFeature(CONFIGURED_CRIMSON_SEAGRASS_MID.getHolder().orElseThrow(), ImmutableList.of(
            InSquarePlacement.spread(),
            PlacementUtils.HEIGHTMAP_TOP_SOLID,
            CountPlacement.of(64),
            BiomeFilter.biome())));

    public static final RegistryObject<PlacedFeature> CRIMSON_SEAGRASS_TALL_PLACED = registerPlacedFeature(CRIMSON_SEAGRASS_TALL_FEATURE_NAME_PLACED, () -> new PlacedFeature(CONFIGURED_CRIMSON_SEAGRASS_TALL.getHolder().orElseThrow(), ImmutableList.of(
            InSquarePlacement.spread(),
            PlacementUtils.HEIGHTMAP_TOP_SOLID,
            CountPlacement.of(60),
            BiomeFilter.biome())));

    public static final RegistryObject<PlacedFeature> CRIMSON_SEAGRASS_TALL_PLACED_COMMON = registerPlacedFeature(CRIMSON_SEAGRASS_COMMON_TALL_FEATURE_NAME_PLACED, () -> new PlacedFeature(CONFIGURED_CRIMSON_SEAGRASS_TALL.getHolder().orElseThrow(), ImmutableList.of(
            InSquarePlacement.spread(),
            PlacementUtils.HEIGHTMAP_TOP_SOLID,
            CountPlacement.of(256),
            BiomeFilter.biome())));
