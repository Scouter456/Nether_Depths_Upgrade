...
public class NDUConfiguredFeatures {
    ...
    public static final RegistryObject<PlacedFeature> VENT_PLACED = PLACED_FEATURES.register(VENT_FEATURE_NAME, () -> new PlacedFeature(CONFIGURED_VENT.getHolder().orElseThrow(), ImmutableList.of(
            RarityFilter.onAverageOnceEvery(25),
            //InSquarePlacement.spread(),
            PlacementUtils.HEIGHTMAP_TOP_SOLID,
            //CountPlacement.of(80),
            BiomeFilter.biome())));
    public static final RegistryObject<PlacedFeature> LAVA_SPONGE_PLACED = PLACED_FEATURES.register(LAVA_SPONGE_FEATURE_NAME, () -> new PlacedFeature(CONFIGURED_LAVA_SPONGE.getHolder().orElseThrow(), ImmutableList.of(
