...
public class NDUStructures {
     ...
     */
    public static final DeferredRegister<Structure<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, NetherDepthsUpgrade.MODID);
     ...
     */
    public static final RegistryObject<Structure<NoFeatureConfig>> NETHER_FORTRESS_PIECE = DEFERRED_REGISTRY_STRUCTURE.register("nether_fortress_piece", () -> (new NetherFortressPiece(NoFeatureConfig.CODEC)));
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(
                NETHER_FORTRESS_PIECE.get(), /* The instance of the structure */
                new StructureSeparationSettings(15 /* average distance apart in chunks between spawn attempts */,
                        5 /* minimum distance apart in chunks between spawn attempts. MUST BE LESS THAN ABOVE VALUE*/,
                        1234567330 /* this modifies the seed of the structure so no two structures always spawn over each-other. Make this large and unique. */),
                true);
