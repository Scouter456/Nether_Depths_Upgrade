...
public class NDUStructDimSpace {
    ...
    public static void addDimensionalSpacing(final WorldEvent.Load event) {
        if(event.getWorld() instanceof ServerWorld){
            ...
            tempMap.putIfAbsent(NDUStructures.NETHER_FORTRESS_PIECE.get(), DimensionStructuresSettings.DEFAULTS.get(NDUStructures.NETHER_FORTRESS_PIECE.get()));
