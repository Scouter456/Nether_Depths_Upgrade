...
public class NDUEnchantments {
    ...
    public static void bootstrap(BootstrapContext<Enchantment> bootstrapContext) {
        ...
        register(bootstrapContext, HELL_STRIDER, Enchantment.enchantment(Enchantment.definition(holderGetter3.getOrThrow(ItemTags.FOOT_ARMOR_ENCHANTABLE), 10, 2, Enchantment.dynamicCost(1, 11), Enchantment.dynamicCost(12, 11), 1, new EquipmentSlotGroup[]{EquipmentSlotGroup.ARMOR})).exclusiveWith(holderGetter2.getOrThrow(EnchantmentTags.BOOTS_EXCLUSIVE)).withEffect(NDUDataComponents.HAS_HELL_STRIDER.get()));
