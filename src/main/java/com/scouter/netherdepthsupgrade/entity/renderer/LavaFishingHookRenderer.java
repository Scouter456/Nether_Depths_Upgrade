...
public class LavaFishingHookRenderer extends EntityRenderer<LavaFishingHook> {
    ...
    public LavaFishingHookRenderer(EntityRendererProvider.Context p_174117_) {
        super(p_174117_);
    }

    public void render(LavaFishingHook pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
        ...
        if (player != null) {
            ...
            if (!itemstack.is(NDUItems.LAVA_FISHING_ROD.get())) {
                LOGGER.info("I am here 22");
                i = -i;
            }
