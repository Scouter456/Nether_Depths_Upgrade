...
public class SoulSuckerRenderer extends GeoEntityRenderer<SoulSuckerEntity> {
    public SoulSuckerRenderer(EntityRendererManager renderManager) {
        super(renderManager, new SoulSuckerModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public RenderType getRenderType(SoulSuckerEntity animatable, float partialTicks, MatrixStack stack,
    ...
    @Override
    public void applyRotations(SoulSuckerEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks, float rotationYaw,
                               float partialTicks) {
