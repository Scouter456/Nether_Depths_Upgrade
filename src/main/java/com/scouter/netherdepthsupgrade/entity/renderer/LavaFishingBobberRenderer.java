...
public class LavaFishingBobberRenderer extends EntityRenderer<LavaFishingBobberEntity, FishingHookRenderState> {
    ...
    public void extractRenderState(LavaFishingBobberEntity fishingHook, FishingHookRenderState fishingHookRenderState, float f) {
    ...
    protected boolean affectedByCulling(LavaFishingBobberEntity fishingHook) {
        return false;
    }
}
