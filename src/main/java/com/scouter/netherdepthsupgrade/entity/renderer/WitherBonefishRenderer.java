...
public class WitherBonefishRenderer extends GeoEntityRenderer<WitherBonefishEntity> {
    ...
    @Override
    protected void applyRotations(WitherBonefishEntity animatable, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick, float nativeScale) {
