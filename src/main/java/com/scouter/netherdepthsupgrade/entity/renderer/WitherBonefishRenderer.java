...
public class WitherBonefishRenderer extends GeoEntityRenderer<WitherBonefishEntity> {
    public WitherBonefishRenderer(EntityRendererManager renderManager) {
        super(renderManager, new WitherBonefishModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public RenderType getRenderType(WitherBonefishEntity animatable, float partialTicks, MatrixStack stack,
    ...
    @Override
    public void applyRotations(WitherBonefishEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks, float rotationYaw,
                   float partialTicks) {
