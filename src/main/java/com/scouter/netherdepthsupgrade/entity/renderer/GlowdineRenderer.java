...
public class GlowdineRenderer extends GeoEntityRenderer<GlowdineEntity> {
    ...
    @Override
    public RenderType getRenderType(GlowdineEntity animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {
    ...
    @Override
    protected void applyRotations(GlowdineEntity animatable, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick, float nativeScale) {
