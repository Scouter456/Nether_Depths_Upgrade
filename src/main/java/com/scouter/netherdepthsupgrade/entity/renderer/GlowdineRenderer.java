...
public class GlowdineRenderer extends GeoEntityRenderer<GlowdineEntity> {
    public GlowdineRenderer(EntityRendererManager renderManager) {
        super(renderManager, new GlowdineModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public RenderType getRenderType(GlowdineEntity animatable, float partialTicks, MatrixStack stack,
    ...
    @Override
    public void applyRotations(GlowdineEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks, float rotationYaw,
                              float partialTicks) {
