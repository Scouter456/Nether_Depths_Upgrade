...
public class MagmaCubefishrenderer extends GeoEntityRenderer<MagmaCubefishEntity> {
    public MagmaCubefishrenderer(EntityRendererManager renderManager) {
        super(renderManager, new MagmaCubefishModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public RenderType getRenderType(MagmaCubefishEntity animatable, float partialTicks, MatrixStack stack,
    ...
    @Override
    public void applyRotations(MagmaCubefishEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks, float rotationYaw,
                               float partialTicks) {
