...
public class ObsidianfishRenderer extends GeoEntityRenderer<ObsidianfishEntity> {
    public ObsidianfishRenderer(EntityRendererManager renderManager) {
        super(renderManager, new ObsidianfishModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public RenderType getRenderType(ObsidianfishEntity animatable, float partialTicks, MatrixStack stack,
    ...
    @Override
    public void applyRotations(ObsidianfishEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks, float rotationYaw,
                               float partialTicks) {
